...
La mayor parte de los paquetes de Bioconductor que suelen encapsular esta matriz de frecuencias en un objeto del tipo 
...
:::{#exm-edgeR-resumen-genes-significativos}
```{r}
